    ...
    <div class="container">
      <div class="galeria__grid">
        <div class="galeria__item">
          <img src="images/prosperecon03.jpg" alt="Prosperecon">
        </div>
        <div class="galeria__item">
          <img src="images/prosperecon02.jpg" alt="Prosperecon">
        </div>
        <div class="galeria__item">
          <img src="images/prosperecon06.jpg" alt="Prosperecon">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="footer__bottom">
        ...
        <a href="https://konverteagencia.com" target="_blank" rel="noopener" class="footer__dev">
          Desenvolvido por
          <img src="images/konverte-logo.png" alt="Konverte Agência">
        </a>
      </div>
    </div>
  </footer>
